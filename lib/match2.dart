...
class Match2 extends StatefulWidget {
  const Match2({super.key, required Map<String, dynamic> matchData});
...
class _Match2State extends State<Match2> {
  ...
  Future<void> fetchStreamUrls() async {
    try {
      DocumentSnapshot document = await FirebaseFirestore.instance.collection('live2').doc('match').get();
      ...
      body: GestureDetector(
        ...
        child: Stack(
          children: [
            ...
            // Show stream buttons if available and toggle visibility
